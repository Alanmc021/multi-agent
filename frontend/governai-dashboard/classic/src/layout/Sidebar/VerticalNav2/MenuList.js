...
export const DashboardMenu = [
    ...
    },
    {
        ...
        icon: <Icons.Bell />,
        path: '/apps/campaigns',
        permission: { module: 'marketing', action: 'read' }, // ← Permissão adicionada
        children: [
            { id: nanoid(), link: '/apps/campaigns/list', name: 'Lista de Campanhas' },
            { id: nanoid(), link: '/apps/campaigns/create', name: 'Nova Campanha' },
        ]
    },
    {
        id: nanoid(),
        ...
        permission: { module: 'marketing', action: 'read' }, // ← Permissão adicionada
        children: [
            { id: nanoid(), link: '/apps/leads/list', name: 'Lista de Leads' },
            { id: nanoid(), link: '/apps/leads/create', name: 'Novo Lead' },
        ]
    },
    {
        id: nanoid(),
    ...
    {
        id: nanoid(),
        title: 'Tipos de Assistentes',
        icon: <Icons.Cpu />,
        link: '/apps/assistant-types',
        permission: { module: 'citizen', action: 'read' }, // ← Permissão adicionada
        badge: <HkBadge size="sm" bg="primary" soft className="ms-auto">New</HkBadge>
    },
    {
        id: nanoid(),
        title: 'Oportunidades',
        icon: <Icons.ChartLine />,
        link: '/apps/opportunities/list',
        permission: { module: 'marketing', action: 'read' }, // ← Permissão adicionada
    },
    {
        id: nanoid(),
        ...
        permission: { module: 'admin', action: 'read' }, // ← Permissão adicionada
    },
    {
        id: nanoid(),
    ...
    },
    {
        ...
        title: 'Studio',
        icon: <Icons.Palette />,
        link: '/apps/studio/avatar-generator',
        permission: { module: 'studio', action: 'write' }, // ← Permissão adicionada
    },
    {
        id: nanoid(),
        title: 'Usuários',
