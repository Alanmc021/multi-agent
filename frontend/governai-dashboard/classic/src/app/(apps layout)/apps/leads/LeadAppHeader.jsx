...
import { Archive, ChevronDown, ChevronUp, Edit, ExternalLink, Grid, List, MoreVertical, RefreshCw, Server, Settings, Slash, Star, Trash2, UserCheck } from 'react-feather';
        ...
        <header className="contact-header">
            <div className="d-flex align-items-center">
                ...
                <Dropdown className="ms-3">
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item as={Link} href="/apps/leads/create">Novo Lead</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            </div>
