...
import { Archive, Book, Download, Inbox, Settings, Star, Upload, UserCheck } from 'react-feather';
                            ...
                            <Nav className="nav-light navbar-nav flex-column">
                                ...
                                <Nav.Item>
                                    <Nav.Link as={Link} href="#">
                                        ...
                                        <span className="nav-link-text">Importantes</span>
                                    </Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link as={Link} href="#">
                                        ...
                                        <span className="nav-link-text">Qualificados</span>
                                    </Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link as={Link} href="#">
                                        ...
                                        <span className="nav-link-text">Arquivados</span>
                                    </Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </div>
